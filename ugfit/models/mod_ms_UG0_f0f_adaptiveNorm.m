function [fval,fit] = mod_ms_UG0_f0f_adaptiveNorm(behavData,q, doprior,dofit,varargin)
...
[qt, bounds] = norm2par('ms_UG0_f0f_adaptiveNorm',q); % transform parameters from gaussian space to model space
